                    ...
                    <form action="{{ route('categories.update', ['category' => $category]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <div>
                                ...
                                <label>Name:</label>
                                <input name="name" placeholder="Name" value="{{ $category->name }}" class="border" >
                            </div>
                            
                            <div>
                                <label>Description:</label>
                                <input name="description" placeholder="Name" value="{{ $category->description }}" class="border" >
                            </div>

                            <div>
                                <label>Slug:</label>
                                <input name="slug" placeholder="Name" value="{{ $category->slug }}" class="border" >
                            </div>
