<x-admin-layout>
        ...
        <h3 class="p-4 text-2xl font-extrabold text-gray-700">Edit Post</h3>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ route('posts.update', ['post' => $post]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="mb-4">
                                ...
                                <input required name="title" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" value="{{ $post->title }}" placeholder="Name">
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="content" id="content" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline ckeditor">{{ $post->content }}</textarea>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="excerpt" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="slug">{{ $post->excerpt }}</textarea>
                            </div>
